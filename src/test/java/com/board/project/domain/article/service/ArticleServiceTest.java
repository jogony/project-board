...
class ArticleServiceTest {
    ...
    @Test
    void givenArticleSearchParameters_whenSearchArticleViaHashtag_thenReturnsEmptyPage() {
        // Given
        Pageable pageable = Pageable.ofSize(20);
        // When
    ...
    @Test
    void givenHashtag_whenSearchArticleViaHashtag_thenReturnsArticlesPage() {
        // Given
        String hashtag = "#java";
        Pageable pageable = Pageable.ofSize(20);
    ...
    void givenArticleIdAndModifiedInfo_whenUpdatingArticle_thenUpdateArticle() {
        ...
        Article article = Fixture.createArticle();
        ArticleDto dto = Fixture.createArticleDto();
